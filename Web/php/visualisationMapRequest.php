...
if($requestRessource == "VisualisationMapSubmit"){
    switch ($requestMethod) {
        case 'GET':
...
// DEFAULT VERSION NO FILTER 

if ($requestMethod == "GET" && $requestRessource == "VisualisationMap") {
    $latitude = getLatitude($db);
    $longitude = getLongitude($db);
