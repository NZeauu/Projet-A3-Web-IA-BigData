...
function GenerationRefresh(data) {
    ...
    // Iterer sur chaque element de data
    data.forEach(function(element) {
      // Extraire les valeurs de latitude et longitude
      var latitude = element[0].latitude;
      var longitude = element[0].longitude;
  
      // Ajouter les valeurs à mapData
      mapData[0].lat.push(latitude);
      mapData[0].lon.push(longitude);
    });
